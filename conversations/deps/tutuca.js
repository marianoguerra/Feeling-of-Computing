...
var require_immutable = __commonJS((exports, module) => {
  (function(global, factory) {
    ...
    function wholeSlice(begin, end, size) {
      return (begin === 0 && !isNeg(begin) || size !== undefined && (begin ?? 0) <= -size) && (end === undefined || size !== undefined && end >= size);
    }
    ...
    let _objHashUID = 0;
    const UID_HASH_KEY = Symbol("__immutablehash__");
    ...
    class IndexedSeqImpl extends SeqImpl {
      toIndexedSeq() {
        return this;
      }
      toString() {
    ...
    class SetSeqImpl extends SeqImpl {
      toSetSeq() {
        return this;
      }
    }
    ...
    function groupByFactory(collection, grouper, context) {
      ...
      const groups = (isOrdered(collection) ? OrderedMap() : Map2()).asMutable();
      collection.__iterate((v, k) => {
    ...
    function concatFactory(collection, values) {
      ...
      const iters = [collection].concat(values).map((v) => {
        if (!isCollection(v)) {
    ...
    function merge$1(...iters) {
      return mergeIntoKeyedWith(this, iters);
    }
    function mergeWith$1(merger, ...iters) {
    ...
    function merge(collection, ...sources) {
      return mergeWithSources(collection, sources);
    }
    function mergeWith(merger, collection, ...sources) {
      return mergeWithSources(collection, sources, merger);
    }
    function mergeDeep$1(collection, ...sources) {
      return mergeDeepWithSources(collection, sources);
    }
    function mergeDeepWith$1(merger, collection, ...sources) {
    ...
    const Map2 = (value) => value === undefined || value === null ? emptyMap() : isMap(value) && !isOrdered(value) ? value : emptyMap().withMutations((map) => {
    ...
    const Stack2 = (value) => value === undefined || value === null ? emptyStack() : isStack(value) ? value : emptyStack().pushAll(value);
    Stack2.of = function(...values) {
    ...
    const Set2 = (value) => value === undefined || value === null ? emptySet() : isSet(value) && !isOrdered(value) ? value : emptySet().withMutations((set2) => {
      const iter = SetCollection(value);
      assertNotInfinite(iter.size);
      iter.forEach((v) => set2.add(v));
    });
    Set2.of = function(...values) {
      return Set2(values);
    };
    ...
    Set2.union = (sets) => {
      ...
      return setArray.length ? SetPrototype.union.apply(Set2(setArray.pop()), setArray) : emptySet();
    };
    ...
    const OrderedSet = (value) => value === undefined || value === null ? emptyOrderedSet() : isOrderedSet(value) ? value : emptyOrderedSet().withMutations((set2) => {
      const iter = SetCollection(value);
      assertNotInfinite(iter.size);
      iter.forEach((v) => set2.add(v));
    });
...
function basicGetSeqInfo(seq) {
  return import_immutable.isIndexed(seq) ? idxInfo : import_immutable.isKeyed(seq) ? keyInfo : seqInfoByClass.get(seq?.constructor) ?? unkInfo;
}
...
function morphNode(domNode, source, target, opts) {
  ...
  if (bothInstanceOf(source, target, VNode) && source.tag === target.tag && source.namespace === target.namespace && source.key === target.key) {
...
// index.js
var import_immutable3 = __toESM(require_immutable(), 1);

// src/oo.js
var import_immutable2 = __toESM(require_immutable(), 1);
...
var CHECK_TYPE_LIST = new FnCheck((v) => import_immutable2.List.isList(v), () => "List expected");
var CHECK_TYPE_MAP = new FnCheck((v) => import_immutable2.Map.isMap(v), () => "Map expected");
var CHECK_TYPE_OMAP = new FnCheck((v) => import_immutable2.OrderedMap.isOrderedMap(v), () => "OrderedMap expected");
var CHECK_TYPE_SET = new FnCheck((v) => import_immutable2.Set.isSet(v), () => "Set expected");
var boolCoercer = (v) => !!v;
...
var EMPTY_LIST = import_immutable2.List();
var listCoercer = (v) => Array.isArray(v) ? import_immutable2.List(v) : null;
...
var imapCoercer = (v) => import_immutable2.Map(v);

class FieldMap extends Field {
  constructor(name, defaultValue = import_immutable2.Map()) {
...
var omapCoercer = (v) => import_immutable2.OrderedMap(v);

class FieldOMap extends Field {
  constructor(name, defaultValue = import_immutable2.OrderedMap()) {
...
var EMPTY_SET = import_immutable2.Set();
var isetCoercer = (v) => Array.isArray(v) ? import_immutable2.Set(v) : v instanceof Set ? import_immutable2.Set(v) : null;
...
class ClassBuilder {
  ...
  build() {
    ...
    const Class = { [name]: import_immutable2.Record(fieldVals, name) }[name];
...
function classFromData(name, { fields = {}, methods, statics }) {
  ...
  for (const field in fields) {
    ...
    } else if (import_immutable2.List.isList(value) || Array.isArray(value)) {
      b.addField(field, import_immutable2.List(value), FieldList);
    } else if (import_immutable2.Set.isSet(value) || value instanceof Set) {
      b.addField(field, import_immutable2.Set(value), FieldSet);
    } else if (import_immutable2.OrderedMap.isOrderedMap(value)) {
    ...
    } else if (import_immutable2.Map.isMap(value) || value?.constructor === Object) {
      b.addField(field, import_immutable2.Map(value), FieldMap);
    } else {
...
var export_isOrderedMap = import_immutable3.isOrderedMap;
var export_isOMap = import_immutable3.isOrderedMap;
var export_isMap = import_immutable3.isMap;
var export_isList = import_immutable3.isList;
var export_isKeyed = import_immutable3.isKeyed;
var export_isIndexed = import_immutable3.isIndexed;
var export_isIMap = import_immutable3.isMap;
var export_Record = import_immutable3.Record;
var export_OMap = import_immutable3.OrderedMap;
var export_List = import_immutable3.List;
var export_ISet = import_immutable3.Set;
var export_IMap = import_immutable3.Map;

export {
  tutuca,
  seqInfoByClass,
  macro,
  export_isOrderedMap as isOrderedMap,
  export_isOMap as isOMap,
  export_isMap as isMap,
  export_isList as isList,
  export_isKeyed as isKeyed,
  export_isIndexed as isIndexed,
  export_isIMap as isIMap,
  injectCss,
  html,
  fieldsByClass,
  css,
  component,
  export_Record as Record,
  ParseContext,
  export_OMap as OMap,
  export_List as List,
  export_ISet as ISet,
